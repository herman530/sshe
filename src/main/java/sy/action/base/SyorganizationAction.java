...
public class SyorganizationAction extends BaseAction<Syorganization> {
	...
	public void save() {
		...
		if (data != null) {
			...
			((SyorganizationServiceI) service).saveOrganization(data,
	...
	public void update() {
		...
		if (!StringUtils.isBlank(data.getId())) {
			if (data.getSyorganization() != null
					&& StringUtils.equals(data.getId(), data
							.getSyorganization().getId())) {
	...
	public void doNotNeedSecurity_getSyorganizationByUserId() {
		...
		List<Syorganization> organizations = ((SyorganizationServiceI) service)
